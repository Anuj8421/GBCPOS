...
2. **Push Orders to Us:**
   ```
   POST https://restaurant-pos-12.preview.emergentagent.com/api/orders/cloud-order-receive
   Headers:
...
```bash
curl -X POST https://restaurant-pos-12.preview.emergentagent.com/api/orders/cloud-order-receive \
...
### Test Status Update:
```bash
curl -X POST https://restaurant-pos-12.preview.emergentagent.com/api/orders/update-status \
  -H "Content-Type: application/json" \
  -d '{
...
### Health Check:
```bash
curl https://restaurant-pos-12.preview.emergentagent.com/api/health
```
